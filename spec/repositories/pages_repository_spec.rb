describe Repositories::PagesRepository do
  ...
  context "creating a new page" do
    it "creates a page" do
      result = subject.create(form_id, "question_text", "question_short_name", "hint_text", "answer_type", "next_page")
      ...
      expect(created_page[:next]).to eq("next_page")
  ...
  context "getting a page" do
    it "gets a page" do
      page_id = subject.create(form_id, "question_text", "question_short_name", "hint_text", "answer_type", "next_page")
  ...
  context "updating a page" do
    it "updates a page" do
      page_id = subject.create(form_id, "question_text", "question_short_name", "hint_text", "answer_type", "next_page")
      update_result = subject.update(page_id, "question_text2", "question_short_name2", "hint_text2", "answer_type2", "next_page")
      page = subject.get(page_id)
  ...
  context "getting pages for a form" do
    it "gets pages for a form" do
      page_id1 = subject.create(form_id, "question_text", "question_short_name", "hint_text", "answer_type", "next_page")
      page_id2 = subject.create(form_id, "question_text", "question_short_name", "hint_text", "answer_type", "next_page")
